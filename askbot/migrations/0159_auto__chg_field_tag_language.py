...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tag.language'
        db.alter_column(u'tag', 'language', self.gf('django.db.models.fields.CharField')(default='', max_length=7))

    def backwards(self, orm):

        # Changing field 'Tag.language'
        db.alter_column(u'tag', 'language', self.gf('django.db.models.fields.CharField')(max_length=7, null=True))
