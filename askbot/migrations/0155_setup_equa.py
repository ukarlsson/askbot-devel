...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tag.language'
        db.add_column(u'tag', 'language',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=7, blank=True),
                      keep_default=False)

        # Adding field 'Tag.persistent'
        db.add_column(u'tag', 'persistent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Thread.language'
        db.add_column('askbot_thread', 'language',
                      self.gf('django.db.models.fields.CharField')(default='en', max_length=7),
                      keep_default=False)

        # Adding field 'User.language'
        db.add_column('auth_user', 'language',
                      self.gf('django.db.models.fields.CharField')(default='en', max_length=7),
                      keep_default=False)

        db.add_column('auth_user', 'equa_id', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Tag.persistent'
        db.delete_column(u'tag', 'persistent')

        # Adding unique constraint on 'Tag', fields ['name']
        db.create_unique(u'tag', ['name'])

        # Deleting field 'Thread.language'
        db.delete_column('askbot_thread', 'language')

        # Deleting field 'User.language'
        db.delete_column('auth_user', 'language')

        db.delete_column('auth_user', 'equa_id')
    ...
    models = {
        ...
        'askbot.tag': {
            ...
            'suggested_by': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'suggested_tags'", 'blank': 'True', 'to': "orm['auth.User']"}),
            'tag_wiki': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'described_tag'", 'unique': 'True', 'null': 'True', 'to': "orm['askbot.Post']"}),
        ...
        'auth.user': {
            ...
            'equa_id': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            ...
            'is_initialized': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
