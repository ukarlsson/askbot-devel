...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        try:
            db.add_column(u'auth_user', 'company', self.gf('django.db.models.fields.CharField')(max_length=100, default='', blank=True), keep_default=False)
        except:
            pass

    def backwards(self, orm):
        db.delete_column(u'auth_user', 'company')
